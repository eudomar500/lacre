#!/usr/bin/env python3
"""Read one stored body attestation from a deployed body probe on Bradbury.
...
FIELDS = ("id", "bh_claimed", "bh_computed", "match", "body_bytes",
          "order_id_found", "eta_day", "shipped", "reason")
